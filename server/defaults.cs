...
$Pref::Server::ConnectionError = "You do not have the correct version of the Torque Game Engine or " @
...
$Pref::Server::AllowColorLoading     = false;
$Pref::Server::WrenchEventsAdminOnly = false;
$Pref::Server::AdminPassword         = "";
$Pref::Server::AllowColorLoading     = false;
...
$Pref::Server::ETardFilter = true;
$Pref::Server::ETardList   = " u , r , ur , wat , wut , wuts , wit , dat , loel , y ,";

$pref::Server::FallingDamage = true;
...
$Pref::Server::RandomBrickColor = false;
$Pref::Server::ResetOnEmpty     = false;
...
$Pref::Net::DisableUPnP        = false;
$pref::Net::FastPackets        = true;
...
$Pref::Server::ClearEventsOnClientExit = true;
$Pref::Server::UseRTB                  = false;
